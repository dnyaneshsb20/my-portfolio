...
const CampusZ = () => {
  ...
  const images = [
    { title: "Dashboard", src: "" },
    { title: "Student Profile", src: "" },
    { title: "Attendance System", src: "" },
    { title: "Grievance Module", src: "" },
    { title: "Events Section", src: "" },
    { title: "Timetable Scheduler", src: "" },
    { title: "Transport & Hostel", src: "" },
    { title: "Exam Module", src: "" },
    { title: "Admin Dashboard", src: "" },
  ];
  ...
  return (
    <div className="min-h-screen bg-secondary/20 text-foreground flex flex-col">
      <header className="bg-primary text-white dark:bg-background dark:text-white py-6 shadow-md text-center">
        <h1 className="text-4xl font-bold mt-12 md:mt-0">Campus Z – Smart Campus Ecosystem</h1>
      ...
      <main className="flex-grow container mx-auto px-4 py-10 max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside pl-4 space-y-2 text-justify">
            ...
            <li>
              <strong>Smart Attendance System:</strong> QR-based, face-recognition, or geo-fencing attendance with real-time syncing and auto-generated reports.
            </li>

            <li>
              <strong>Centralized Student Profile:</strong> Stores academic history, certifications, achievements, documents, and skill analytics.
            </li>

            <li>
              <strong>Complaint & Grievance Management:</strong> Track hostel, classroom, and facility complaints with full workflow from submission to resolution.
            </li>

            <li>
              <strong>Events & Social Hub:</strong> Club activities, festivals, seminars, registration, ticketing, and campus-wide announcements.
            </li>

            <li>
              <strong>Smart Timetable & Scheduler:</strong> Auto-generated, conflict-free schedules with faculty substitution suggestions.
            </li>

            <li>
              <strong>Transport & Hostel Management:</strong> Bus tracking, seat allocation, hostel room assignment, and visitor logs.
            </li>

            <li>
              <strong>Result & Exam Module:</strong> Digital mark sheets, internal/external/practical marks entry, analysis graphs for students and faculty.
            </li>

            <li>
              <strong>Admin Analytics Dashboard:</strong> Attendance trends, complaint statistics, event participation, academic insights.
            </li>

            <li>
              <strong>Campus Communication System:</strong> Secure messaging, automated alerts, reminders, and notifications.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside pl-4 space-y-2 text-justify">
            <li>
              <strong>For Students:</strong> One platform for attendance, academics, complaints, events, and communication. Faster resolutions and more transparency.
            </li>

            <li>
              <strong>For Faculty:</strong> Automated attendance, grading, and real-time performance insights.
            </li>

            <li>
              <strong>For Management:</strong> Centralized monitoring, data-driven decisions, and 30–40% reduction in administrative workload.
            </li>

            <li>
              <strong>For Campus Environment:</strong> Reduced paperwork, improved discipline, and full digitization of campus operations.
            </li>
          </ul>
        </section>
