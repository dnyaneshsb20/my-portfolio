...
const AboutSection = () => {
  ...
  const extraCurricular = [
    ...
    <li key={2}><strong>Finalist – Innverve X: Army Institute of Technology Competition</strong>: Reached the finalist stage by pitching the SmartQRDocs concept during the Ideathon Round and successfully building the solution in the Final Hackathon Round, demonstrating innovation, technical execution, and teamwork in a highly competitive environment.</li>,
    <li key={3}>Participated in <strong>Smart India Hackathon (SIH) 2025</strong>, collaborating in a team to work on a real-world problem statement and develop a practical solution within a competitive, time-bound environment. Gained hands-on experience in problem-solving, system design, teamwork, and applying technical skills to address real-life challenges.</li>,
    <li key={4}><strong>Participant – Central India Hackathon (CIH 3.0)</strong>: Proposed the SmartQRDocs concept during the ideation round aligned with UN SDG themes; gained hands-on experience in problem identification, idea pitching, and sustainability-focused solution design at a national-level hackathon.</li>,
